...
export class Player {
    ...
    public pause() {
        ...
        this.showWave=false;
        this.wavePauseTime=this.playbackStrategy.getCurrentTime();
    }
    ...
    private setStrategy(track: Track): PlaybackStrategy {
        ...
        //         model_type: "App\\Track",
        //         album_name: "Detroit 2",
        //         number: 4,
        //         duration:199758,
        //         artists: [
        //             {artist_type: "App\\Artist",id: 4,image: null,model_type: "App\\MixedArtist",name: "Big Sean"},
        //             {artist_type: "App\\Artist",id: 5,image: null,model_type: "App\\MixedArtist",name: "Post Malone"}
        //         ],
        //         youtube_id: null,
        //         plays_count: 37,
        ...
        //         created_at:null,
        //         updated_at: null,
        //         created_at_relative:null
        //    }
        //    let params={tracks: [track], queuedItemId: ''}
        //    this.overrideQueue(params, 0);
        // }
        if(track && !track.url){
