...
export class MobileSearchBarComponent implements OnInit {
    ...
    constructor(
        ...
        $(document).ready(function () {
            $(".show-flters").click(function () {
                $('.hide-filters').toggleClass('showhide-filters');
            });
        });

        $(document).ready(function () {
            $(".show-flters-2").click(function () {
                $('.hide-filters-2').toggleClass('showhide-filters-2');
            });

            $(".close_searchby_filter").on("click", function () {
                $('.hide-filters').removeClass('showhide-filters');
            });

            $(".close_trending_filter").on("click", function () {
                $('.hide-filters-2').removeClass('showhide-filters-2');
            });

            $(".hide-filters select").change(function () {
                $('.hide-filters').removeClass('showhide-filters');
            });
        });
    }
