import {Component, ChangeDetectorRef,ElementRef, OnDestroy, OnInit, Renderer2, ViewChild, ViewEncapsulation} from '@angular/core';
...
export class WebPlayerComponent implements OnInit, OnDestroy {
    ...
    isRouter(){
        ...
        if(url.includes('/dashboard') || url.includes('/playlist')){
            return true;
        }else{
            return false;
        }
